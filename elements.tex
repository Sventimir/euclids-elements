...
sym_ac = symmetral(a, c)
sym_bc = symmetral(c, b)

d = sym_ac.find(a.dist(c) * math.sqrt(3.0) / 2.0)
e = sym_bc.find(b.dist(c) * math.sqrt(3.0) / 2.0)
f = sym_bc.find(b.dist(c) * math.sqrt(3.0) / (-2.0))
g = sym_ac.find(a.dist(c) * math.sqrt(3.0) / (-2.0))
