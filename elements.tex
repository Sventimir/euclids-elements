...
\begin{proof}
    ...
    ABG \cong \triangle AFB\), ponieważ dzielą one wspólny bok \(AB\), a \(|BF|
    = |AG|\) \prop{1.4}. Zatem \(|\measuredangle FAB| = |\measuredangle GBA|\),
...
draw_lines(c, d)
    ...
    \begin{proof}
      ...
      \common{1}, wobec czego \(\triangle BCD\) nie może być równoramienny
...
draw_lines(a, d, b)
    ...
    \begin{proof}
        Niech \(|AB| = |DE|\), \(|AC| = |AF|\) i \(|CB| = |FE|\). Jeżeli zatem
