...
\begin{enumerate}
    \itemsep0em
    \item \mkdef \bold{Punkt} jest tym, co niepodzielne.
    \item \mkdef \bold{Linia} jest to długość bez szerokości.
    \item \mkdef Linia jest ograniczona punktami.
    \item \mkdef
        \bold{Prosta} jest to linia, położona równomiernie względem swoich
        punktów.
    \item \mkdef \bold{Powierzchnia} posiada tylko długość i szerokość.
    \item \mkdef Powierzchnia jest ograniczona liniami.
    \item \mkdef
        \bold{Płaszczyzna} jest to powierzhnia położona równomiernie względem
        swoich punktów.
    \item \mkdef
        \bold{Kąt płaski} jest to wzajemne nachylenie linii leżących w jednej
    ...
    \item \mkdef \bold{Kątem rozwartym} nazywa się kąt większy od kąta prostego.
    \item \mkdef Zaś \bold{kątem ostrym} nazywa się kąt mniejszy od kąta prostego.
    \item \mkdef Granicą jest to, co leży na skraju czegoś.
    \item \mkdef Granice tworzą \bold{figurę}.
    \item \mkdef
        \bold{Okrąg} jest to figura płaska, ograniczona jedną linią (zwaną
        obwodem) w taki sposób, że proste linie łączące jeden z punktów wewnątrz
        tej figury z granicą, są sobie równe.
    \item \mkdef A punkt ten jest nazywany \bold{środkiem} okręgu.
    \item \mkdef
        \bold{Średnica} okręgu jest to dowolna linia prosta łącząca dwa punkty
        na [granicy] okręgu i przechodząca przez jego środek. Każda średnica
        dzieli okrąg na dwie połowy.
    \item \mkdef
        \bold{Półokrąg} jest to połowa okręgu ograniczona średnicą wraz z tą
        średnicą. Środkiem półokręgu jest środek okręgu, z którego został
        wycięty.
    \item \mkdef
        \bold{Figury prostoliniowe} są to figury ograniczone wyłącznie
        prostymi liniami; \bold{trójkąty} są ograniczone trzema liniami,
        \bold{czworokąty}, czterem liniami, a \bold{wielokąty}, więcej niż
        czterema liniami.
    \item \mkdef
        \bold{Trójkąt równoboczny} to taki, którego wszystkie boki są równe;
    ...
    \item \mkdef
        \bold{Trójkąt prostokątny} to taki, który zawiera kąt prosty;
    ...
    \item \mkdef
        \bold{Kwadrat} jest to czworokąt posiadające cztery kąty proste
    ...
    \item \mkdef
        \bold{Linie równoległe} to takie linie leżące w jednej płaszczyźnie,
